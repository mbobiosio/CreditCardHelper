package com.mbobiosio.creditcardhelper;
...
/**
 * Created by Mbuodile Obiosio on 7/12/18
 * cazewonder@gmail.com
 */
public class CreditCardUtils {
    public enum CardType {
        UNKNOWN_CARD, AMEX_CARD, MASTER_CARD, VISA_CARD, DISCOVER_CARD,VERVE_CARD
    }

    private static final String PATTERN_AMEX = "^3[47][0-9]{13}$";
    private static final String PATTERN_VISA = "^4[0-9 ]*";
    private static final String PATTERN_MASTER = "^(?:5[1-5][0-9]{2}|222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720)[0-9]{12}$";
    private static final String PATTERN_DISCOVER = "^6[0-9 ]*";
    private static final String PATTERN_VERVE = "^((506(0|1))|(507(8|9))|(6500))[0-9]{12,15}$";


    public static final int MAX_LENGTH_CARD_NUMBER = 16;
    public static final int MAX_LENGTH_CARD_NUMBER_AMEX = 15;
    public static final int MAX_LENGTH_CARD_NUMBER_VERVE = 19;
    ...
    public static final String CARD_NUMBER_FORMAT_VERVE = "XXXX XXXX XXXX XXXX XXX";
    ...
    public static final String BANK_PIN_CODE = "pin_code";
    ...
    public static CardType selectCardType(String cardNumber) {
        ...
        pCardType = Pattern.compile(PATTERN_VERVE);
        if(pCardType.matcher(cardNumber).matches())
            return CardType.VERVE_CARD;
        return CardType.UNKNOWN_CARD;
    }

    public static int selectCardLength(CardType cardType) {
        return cardType == CardType.VERVE_CARD ? MAX_LENGTH_CARD_NUMBER_VERVE : MAX_LENGTH_CARD_NUMBER;
    }
    ...
    public static String handleCardNumber(String inputCardNumber, String seperator) {
        ...
        String format = (cardType == CardType.VERVE_CARD) ? CARD_NUMBER_FORMAT_VERVE : CARD_NUMBER_FORMAT;
